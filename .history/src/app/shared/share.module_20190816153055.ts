...
import { ExecuteRobotService, ToastrService } from './services';
...
export class SharedModule {
    static forRoot(): ModuleWithProviders {
        return {
            ...
            providers: [ParseService, AuthGuard, AuthService, LoadingService, ShareDataService, ExecuteRobotService, ToastrService],
        };
    }
}
