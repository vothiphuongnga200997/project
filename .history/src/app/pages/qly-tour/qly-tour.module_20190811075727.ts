...
import { MienBacComponent } from './mien-bac/mien-bac.component';

@NgModule({
    imports: [ThemeModule, SharedModule, Ng2SmartTableModule],
    exports: [QuanLyTourComponent],
    declarations: [QuanLyTourComponent, TourChuaDiComponent, DsTourComponent, TourDangDiComponent, TourDaDiComponent, MienBacComponent],
})
