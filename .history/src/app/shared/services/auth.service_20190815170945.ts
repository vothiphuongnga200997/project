...
export class AuthService {
    ...
    //     try {
    //         return await this.msalService.loginPopup(['user.read']);
    //         // let token = await this.msalService.acquireTokenPopup(['user.read']);
    //         // let userInfo = await this.msalService.getUser();
    //     } catch (ex) {
    //         throw ex;
    //     }
    // }
