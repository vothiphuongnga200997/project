...
import { QuanLyTourModule } from './quan-ly-tour/quan-ly-tour.module';
import { QlyKhachHangComponent } from './qly-khach-hang/qly-khach-hang.component';

const PAGES_COMPONENTS = [PagesComponent];

@NgModule({
    imports: [PagesRoutingModule, ThemeModule, SharedModule, ReportWorkFlowModule, LoginModule, RobotsManagementModule, HomeModule, QuanLyTourModule],
