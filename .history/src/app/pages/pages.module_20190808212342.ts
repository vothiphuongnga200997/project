...
import { LibraryDependenciesModule } from './library-dependencies/library-dependencies.module';
...
@NgModule({
    imports: [
        ...
        ScheduleModule,
        FileAgentModule,
        LibraryDependenciesModule,
    ],
    declarations: [...PAGES_COMPONENTS, QuickstartAddingModalComponent, HomeComponent],
